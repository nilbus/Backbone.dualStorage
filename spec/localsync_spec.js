    ...
    describe('standard Backbone.sync methods', function() {
      describe('creating records', function() {
        it('creates records', function() {
          var create, model, options, ready, _ref;
          _ref = {}, ready = _ref.ready, create = _ref.create, model = _ref.model, options = _ref.options;
          runs(function() {
        ...
        return it('supports marking a new record dirty', function() {
          var create, dirty, model, options, ready, _ref;
          _ref = {}, ready = _ref.ready, create = _ref.create, model = _ref.model, dirty = _ref.dirty, options = _ref.options;
          runs(function() {
            model = new Backbone.Model({
              id: 1
            });
      ...
      describe('updating records', function() {
        it('updates records', function() {
          var model, options, ready, update, _ref;
          _ref = {}, ready = _ref.ready, update = _ref.update, model = _ref.model, options = _ref.options;
          runs(function() {
        ...
        return it('supports marking an updated record dirty', function() {
          var dirty, model, options, ready, update, _ref;
          _ref = {}, ready = _ref.ready, update = _ref.update, model = _ref.model, dirty = _ref.dirty, options = _ref.options;
          runs(function() {
            model = new Backbone.Model({
              id: 1
            });
