...
(function() {
  var backboneSync, collection, dualSync, localStorage, localsync, model, ref,
  ...
  describe('using Backbone.sync directly', function() {
    return it('should save and retrieve data', function() {
      var errorCallback, fetched, ref1, saved, successCallback;
      ref1 = {}, successCallback = ref1.successCallback, errorCallback = ref1.errorCallback;
      saved = false;
      runs(function() {
        localStorage.clear();
  ...
  describe('using backbone models and retrieving from local storage', function() {
    ...
    return it("works with an idAttribute other than 'id'", function() {
      ...
      NonstandardModel = (function(superClass) {
        extend(NonstandardModel, superClass);
