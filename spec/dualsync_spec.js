...
(function() {
  var Backbone, ModelWithAlternateIdAttribute, backboneSync, collection, localStorage, localsync, model, ref, spyOnLocalsync,
    slice = [].slice;

  Backbone = window.Backbone, backboneSync = window.backboneSync, localsync = window.localsync, localStorage = window.localStorage;

  ref = {}, collection = ref.collection, model = ref.model, ModelWithAlternateIdAttribute = ref.ModelWithAlternateIdAttribute;
...
//# sourceMappingURL=dualsync_spec.js.map
